...
#define STRING_CONFIG_H_AUTHOR "(nahyup, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "HEVO by Nahyup"
 ...
 */
// Nahyup Enabled BLTOUCH for HEVO
#define BLTOUCH
#if ENABLED(BLTOUCH)
